...
<div id="main">
      ...
      <div class="header_section">
        <div class="container-fluid">
         <div class="row">
            <div class="col-sm-4">
               <div class="search_icon"><img src="resources/images/search-icon.png"></div>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
               <div class="togle_3">
                  ...
                  <div class="middle_main">
                     <div class="shoping_bag"><img src="resources/images/shopping-bag.png"></div>
                  </div>
                  <div class="right_main">
                     <div class="togle_main"><a class="class="openbtn onclick="openNav()"><img src="resources/images/togle-menu-icon.png" style="max-width: 100%;"></a></div>
                  </div>
               </div>
               </div>
            </div>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="resources/images/img-1.png" style="max-width: 100%;"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
   ...
   <div class="about_section">
      <div class="container">
         <div class="about_img"><img src="resources/images/about-img1.png" style="max-width: 100%;"></div>
      ...
      <div class="our_section_2">
         <div class="our_main">
            <div id="my_slider" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="resources/images/our-img-1.png" alt="First slide">
               </div>
               <div class="carousel-item">
                  <img class="d-block w-100" src="resources/images/our-img-1.png" alt="Second slide">
               </div>
               <div class="carousel-item">
                 <img class="d-block w-100" src="resources/images/our-img-1.png" alt="Third slide">
               </div>
            </div>
   ...
   <div class="testimonial_section layout_padding">
      <div class="container">
         ...
         <div class="images_3"><img src="resources/images/img-3.png"></div>
         <h2 class="rooty_text">Rooty</h2>
         <p class="ice_text">(lcc)</p>
         <div><img src="resources/images/left-quote.png"></div>
         ...
         <div class="right_quote"><img src="resources/images/right-quote.png"></div>
      </div> 
   </div>
